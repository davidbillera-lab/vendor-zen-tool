/**
 * logger.js — DOA Bulk Upload Agent
...
function writeToFile(filename, message) {
  try {
    fs.appendFileSync(path.join(LOGS_DIR, filename), `[${new Date().toISOString()}] ${message}\n`, 'utf8');
  } catch { /* log file errors are non-fatal */ }
}
...
const log = {
  ...
  getScreenshotsDir() { return SCREENSHOTS_DIR; },
};
